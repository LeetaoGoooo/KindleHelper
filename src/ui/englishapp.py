...
"}")
    ...
    def retranslateUi(self, KindleHelper):
        ...
        KindleHelper.setWindowTitle(_translate("KindleHelper", "Kindle assistant"))
        self.downloadTab.setTabText(self.downloadTab.indexOf(self.direct_download), _translate("KindleHelper", "Download"))
        self.downloadTab.setTabText(self.downloadTab.indexOf(self.netpan), _translate("KindleHelper", "netdisc"))
        #self.open_download_dir_btn.setText(_translate("KindleHelper", "打开目录"))
        self.send_btn.setText(_translate("KindleHelper", "Push file"))
        self.done_btn.setText(_translate("KindleHelper", "Download completed"))
        self.about_btn.setText(_translate("KindleHelper", "About"))
        self.downloading_btn.setText(_translate("KindleHelper", "Downloading"))
        #self.new_task_btn.setText(_translate("KindleHelper", "新建任务"))
        self.search_btn.setText(_translate("KindleHelper", "Search"))
